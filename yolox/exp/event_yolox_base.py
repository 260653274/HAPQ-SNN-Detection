...
class EventExp(BaseExp):
    def __init__(self):
        ...
        # ---------------- HAPQ config ---------------- #
        self.enable_hapq = False
        self.hapq_mode = "full_nas"
        self.hapq_stage = "full"
        self.hapq_export_path = ""
        self.hapq_block_size = 8
        self.hapq_channel_choices = [64, 128, 256]
        self.hapq_kernel_choices = [1, 3, 5]
        self.hapq_depth_choices = [1, 2, 3]
        self.hapq_bit_choices_w = [4, 6, 8, 12]
        self.hapq_bit_choices_u = [6, 8, 12, 16]
        self.hapq_leak_shift_choices = [2, 3, 4]
        self.hapq_nas_iters = 20
        self.hapq_nas_population = 8
        self.hapq_nas_topk = 3
        self.hapq_nas_mutation = 0.25
        self.hapq_tau_lat = 2.5e7
        self.hapq_tau_eng = 1500.0
        self.hapq_tau_dsp = 1600
        self.hapq_tau_bram = 1200
        self.hapq_tau_bw = 5e8
        self.hapq_tau_lut = 2e5
        self.hapq_lambda_lat = 1.0
        self.hapq_lambda_eng = 1.0
        self.hapq_lambda_dsp = 1.0
        self.hapq_lambda_bram = 1.0
        self.hapq_lambda_bw = 1.0
        self.hapq_lambda_lut = 1.0
        # ---------------- SNN related config ---------------- #
        # embedding method
        self.emb_lr = -1.0
        ...
        self.data_dir = '/home/xlang/EAS-SNN/datasets/Gen1'
    ...
    def get_hapq_config(self):
        return {
            "mode": self.hapq_mode,
            "stage": self.hapq_stage,
            "export_path": self.hapq_export_path,
            "block_size": self.hapq_block_size,
            "channel_choices": self.hapq_channel_choices,
            "kernel_choices": self.hapq_kernel_choices,
            "depth_choices": self.hapq_depth_choices,
            "bit_choices_w": self.hapq_bit_choices_w,
            "bit_choices_u": self.hapq_bit_choices_u,
            "leak_shift_choices": self.hapq_leak_shift_choices,
            "nas_iters": self.hapq_nas_iters,
            "nas_population": self.hapq_nas_population,
            "nas_topk": self.hapq_nas_topk,
            "nas_mutation": self.hapq_nas_mutation,
            "tau_lat": self.hapq_tau_lat,
            "tau_eng": self.hapq_tau_eng,
            "tau_dsp": self.hapq_tau_dsp,
            "tau_bram": self.hapq_tau_bram,
            "tau_bw": self.hapq_tau_bw,
            "tau_lut": self.hapq_tau_lut,
            "lambda_lat": self.hapq_lambda_lat,
            "lambda_eng": self.hapq_lambda_eng,
            "lambda_dsp": self.hapq_lambda_dsp,
            "lambda_bram": self.hapq_lambda_bram,
            "lambda_bw": self.hapq_lambda_bw,
            "lambda_lut": self.hapq_lambda_lut,
    ...
    def get_eval_dataset(self, **kwargs):
        ...
        if self.data_name == 'n-caltech':
            ...
            data_dir = os.path.join(self.data_dir, 'test', 'detection_dataset_duration_60s_ratio_1.0', 'test')
